...
const tableElRef = ref<ComponentPublicInstance | null>(null)
...
<template>
  ...
  <div class="s-table">
    <n-data-table
      ref="tableElRef" v-bind="getBindValues" :striped="isStriped" :pagination="pagination"
